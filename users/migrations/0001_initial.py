    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('availability', models.CharField(blank=True, choices=[('full_time', 'Full Time'), ('part_time', 'Part Time')], max_length=50, null=True)),
                ('hourly_salary', models.DecimalField(decimal_places=2, max_digits=10, null=True)),
                ('about_me', models.TextField(blank=True, null=True)),
                ('password', models.CharField(max_length=100, null=True)),
                ('created_at', models.DateTimeField(default=django.utils.timezone.now)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('service_types', models.ManyToManyField(blank=True, to='services.servicetype')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(default=django.utils.timezone.now)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('service_needed', models.ManyToManyField(blank=True, to='services.servicetype')),
                ('user_profile', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='users.userprofile')),
            ],
        ),
    ]
